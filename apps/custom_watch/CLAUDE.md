...
| **Buttons / navigation / modals — read before touching the press grammar.** Every state, page, and button edge; §350 spatial paging (BTN3/BTN4 tap left/right, BTN5 lap — doubling as workout-step skip when a workout is armed, §354; one-tier 0.5 s hold); §351 idle settings menu (BTN2/BTN3 cursor up/down, BTN5/BTN1 directional edits, BTN4 exit); the computed press-cost model + the "every interaction, priced" floor table | [../../docs/custom_watch/navigation.md](../../docs/custom_watch/navigation.md) |
