...
//!    step and a pace drift all want a decision inside seconds; a front measured over three
...
//!    runs.
//! 8. **Eat**, then **Drink** — a reminder can wait eight seconds, so these
...
//! 9. **GPS lost / GPS back**, then **Back-on-course**, then **Timer**, then
