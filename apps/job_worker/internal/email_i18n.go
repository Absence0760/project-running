...
var emailCatalogue = map[string]map[string]emailStrings{
	"en": {
		...
		"plan_assigned":      {"Your coach assigned you a training plan", "A new plan is waiting in your training.", "New training plan assigned", "View plan", []string{"Your coach assigned you a training plan.", "Open it for this week's sessions and your target paces."}},
		"achievement":        {"You earned a new achievement", "A new achievement is on your profile.", "New achievement earned", "View achievement", []string{"You earned a new achievement on Threkir.", "Open it to see what unlocked it — and share it if you like."}},
		"challenge_complete": {"You completed a challenge", "You hit the goal — see the final standings.", "Challenge complete", "View challenge", []string{"You reached the goal on a challenge you joined.", "Open it for the final standings and your result."}},
		"data_export_ready":  {"Your data export is ready", "Your account export has finished building — collect it from Settings.", "Your data export is ready", "Open Settings", []string{"The account export you asked for has finished building.", "Open Settings then Account to download it. The download link is created when you get there, so nothing in this email expires while it waits — the archive itself is kept for 7 days."}},
		"refund_failed":      {"A refund we started couldn't be completed", "The money is still with us — we'll arrange another way to return it.", "Your refund didn't reach you", "See the details", []string{"A refund we started for you was sent back to us by the bank, so the money has not reached your account.", "Nothing went wrong on your side and you do not need to pay again. Reply to this email or write to billing@threkir.com and we will arrange another way to return it."}},
		...
		"safety_overdue":     {"Is %s OK? Their run has gone quiet", "No position received for a while — check their live progress.", "No recent update from %s", "View live progress", []string{"%s started a run at %s and last reported a position at %s. That's longer than the quiet window they set for alerting you.", "%s started a run at %s and no position has been received since the start. That's longer than the quiet window they set for alerting you.", "This can also mean loss of phone signal or a stopped app. Check their live progress below; if you can't reach them and are worried, consider contacting local emergency services."}},
		"safety_off_route":   {"Is %s still on course? They've left their route", "Off their planned route for a while — check their live progress.", "%s has gone off route", "View live progress", []string{"%s started a run at %s and, as of %s, has moved well off their planned route and stayed there.", "%s started a run at %s and has moved well off their planned route.", "This can also mean a deliberate detour or a GPS glitch. Check their live progress below; if you can't reach them and are worried, consider contacting local emergency services."}},
	...
	"de": {
		...
		"plan_assigned":      {"Dein Coach hat dir einen Trainingsplan zugewiesen", "Ein neuer Plan wartet in deinem Training.", "Neuer Trainingsplan zugewiesen", "Plan ansehen", []string{"Dein Coach hat dir einen Trainingsplan zugewiesen.", "Öffne ihn für die Einheiten dieser Woche und deine Zielpaces."}},
		"achievement":        {"Du hast einen neuen Erfolg erzielt", "Ein neuer Erfolg ist jetzt in deinem Profil.", "Neuer Erfolg erzielt", "Erfolg ansehen", []string{"Du hast auf Threkir einen neuen Erfolg erzielt.", "Öffne ihn, um zu sehen, wofür du ihn bekommen hast — und teile ihn, wenn du magst."}},
		"challenge_complete": {"Du hast eine Challenge abgeschlossen", "Du hast das Ziel erreicht — sieh dir die Endplatzierung an.", "Challenge abgeschlossen", "Challenge ansehen", []string{"Du hast das Ziel einer Challenge erreicht, an der du teilnimmst.", "Öffne sie für die Endplatzierung und dein Ergebnis."}},
		"data_export_ready":  {"Dein Datenexport ist fertig", "Dein Kontoexport wurde erstellt — du kannst ihn in den Einstellungen abholen.", "Dein Datenexport ist fertig", "Einstellungen öffnen", []string{"Der von dir angeforderte Kontoexport wurde fertiggestellt.", "Öffne Einstellungen und dann Konto, um ihn herunterzuladen. Der Download-Link wird erst dort erzeugt, es läuft also nichts in dieser E-Mail ab — das Archiv selbst wird 7 Tage aufbewahrt."}},
		"refund_failed":      {"Eine gestartete Erstattung konnte nicht abgeschlossen werden", "Das Geld liegt noch bei uns – wir finden einen anderen Weg der Rückzahlung.", "Deine Erstattung ist nicht angekommen", "Details ansehen", []string{"Eine für dich gestartete Erstattung wurde von der Bank zurückgeschickt, das Geld ist also nicht auf deinem Konto angekommen.", "Auf deiner Seite ist nichts schiefgelaufen, und du musst nicht erneut zahlen. Antworte auf diese E-Mail oder schreibe an billing@threkir.com, dann finden wir einen anderen Weg der Rückzahlung."}},
		...
		"safety_overdue":     {"Ist %s okay? Der Lauf meldet sich nicht mehr", "Seit einiger Zeit keine Position — sieh dir den Live-Fortschritt an.", "Keine aktuelle Meldung von %s", "Live-Fortschritt ansehen", []string{"%s hat um %s einen Lauf gestartet und zuletzt um %s eine Position gemeldet. Das ist länger als das eingestellte Alarm-Zeitfenster.", "%s hat um %s einen Lauf gestartet und seit dem Start keine Position gemeldet. Das ist länger als das eingestellte Alarm-Zeitfenster.", "Das kann auch an fehlendem Handyempfang oder einer beendeten App liegen. Sieh dir unten den Live-Fortschritt an; wenn du die Person nicht erreichst und dir Sorgen machst, kontaktiere im Zweifel den örtlichen Notruf."}},
		"safety_off_route":   {"Ist %s noch auf Kurs? Der Lauf hat die Route verlassen", "Seit einiger Zeit abseits der geplanten Route — sieh dir den Live-Fortschritt an.", "%s ist von der Route abgekommen", "Live-Fortschritt ansehen", []string{"%s hat um %s einen Lauf gestartet und ist seit %s deutlich von der geplanten Route abgekommen und dort geblieben.", "%s hat um %s einen Lauf gestartet und ist deutlich von der geplanten Route abgekommen.", "Das kann auch ein bewusster Umweg oder ein GPS-Fehler sein. Sieh dir unten den Live-Fortschritt an; wenn du die Person nicht erreichst und dir Sorgen machst, kontaktiere im Zweifel den örtlichen Notruf."}},
	...
	"fr": {
		...
		"plan_assigned":      {"Votre coach vous a attribué un plan d'entraînement", "Un nouveau plan vous attend dans votre entraînement.", "Nouveau plan d'entraînement attribué", "Voir le plan", []string{"Votre coach vous a attribué un plan d'entraînement.", "Ouvrez-le pour les séances de la semaine et vos allures cibles."}},
		"achievement":        {"Vous avez obtenu un nouveau succès", "Un nouveau succès figure sur votre profil.", "Nouveau succès obtenu", "Voir le succès", []string{"Vous avez obtenu un nouveau succès sur Threkir.", "Ouvrez-le pour voir ce qui l'a débloqué — et partagez-le si vous le souhaitez."}},
		"challenge_complete": {"Vous avez terminé un défi", "Objectif atteint — voyez le classement final.", "Défi terminé", "Voir le défi", []string{"Vous avez atteint l'objectif d'un défi auquel vous participez.", "Ouvrez-le pour le classement final et votre résultat."}},
		"data_export_ready":  {"Votre export de données est prêt", "Votre export de compte est terminé — récupérez-le dans les réglages.", "Votre export de données est prêt", "Ouvrir les réglages", []string{"L'export de compte que vous avez demandé est terminé.", "Ouvrez Réglages puis Compte pour le télécharger. Le lien de téléchargement est créé à ce moment-là : rien dans cet e-mail n'expire pendant l'attente, et l'archive elle-même est conservée 7 jours."}},
		"refund_failed":      {"Un remboursement que nous avions lancé n'a pas pu aboutir", "L'argent est toujours chez nous — nous trouverons un autre moyen de vous le rendre.", "Votre remboursement ne vous est pas parvenu", "Voir les détails", []string{"Un remboursement que nous avions lancé pour vous a été renvoyé par la banque : l'argent n'est donc pas arrivé sur votre compte.", "Rien n'a échoué de votre côté et vous n'avez pas à payer de nouveau. Répondez à cet e-mail ou écrivez à billing@threkir.com et nous trouverons un autre moyen de vous le rendre."}},
		...
		"safety_overdue":     {"Est-ce que %s va bien ? Sa course ne donne plus signe", "Aucune position reçue depuis un moment — consultez sa progression en direct.", "Aucune nouvelle récente de %s", "Voir la progression en direct", []string{"%s a commencé une course à %s et a signalé sa dernière position à %s. C'est plus long que la fenêtre d'alerte configurée.", "%s a commencé une course à %s et aucune position n'a été reçue depuis le départ. C'est plus long que la fenêtre d'alerte configurée.", "Cela peut aussi venir d'une perte de signal ou d'une application arrêtée. Consultez la progression en direct ci-dessous ; si vous n'arrivez pas à joindre la personne et que vous êtes inquiet, envisagez de contacter les secours locaux."}},
		"safety_off_route":   {"%s est-il toujours sur le parcours ? Il a quitté son itinéraire", "Hors de l'itinéraire prévu depuis un moment — consultez sa progression en direct.", "%s a quitté son itinéraire", "Voir la progression en direct", []string{"%s a commencé une course à %s et, depuis %s, s'est nettement écarté de l'itinéraire prévu et y est resté.", "%s a commencé une course à %s et s'est nettement écarté de l'itinéraire prévu.", "Cela peut aussi être un détour volontaire ou une erreur GPS. Consultez la progression en direct ci-dessous ; si vous n'arrivez pas à joindre la personne et que vous êtes inquiet, envisagez de contacter les secours locaux."}},
	...
	"es": {
		...
		"plan_assigned":      {"Tu entrenador te asignó un plan de entrenamiento", "Tienes un plan nuevo esperando en tu entrenamiento.", "Nuevo plan de entrenamiento asignado", "Ver plan", []string{"Tu entrenador te asignó un plan de entrenamiento.", "Ábrelo para ver las sesiones de esta semana y tus ritmos objetivo."}},
		"achievement":        {"Has conseguido un nuevo logro", "Ya tienes un nuevo logro en tu perfil.", "Nuevo logro conseguido", "Ver logro", []string{"Has conseguido un nuevo logro en Threkir.", "Ábrelo para ver con qué lo desbloqueaste y compártelo si quieres."}},
		"challenge_complete": {"Completaste un desafío", "Alcanzaste el objetivo: mira la clasificación final.", "Desafío completado", "Ver desafío", []string{"Alcanzaste el objetivo de un desafío en el que participas.", "Ábrelo para ver la clasificación final y tu resultado."}},
		"data_export_ready":  {"Tu exportación de datos está lista", "Tu exportación de cuenta ha terminado: recógela en Ajustes.", "Tu exportación de datos está lista", "Abrir Ajustes", []string{"La exportación de cuenta que pediste ha terminado de generarse.", "Abre Ajustes y luego Cuenta para descargarla. El enlace de descarga se crea al llegar allí, así que nada de este correo caduca mientras espera; el archivo se conserva 7 días."}},
		"refund_failed":      {"Un reembolso que iniciamos no se pudo completar", "El dinero sigue con nosotros: buscaremos otra forma de devolvértelo.", "Tu reembolso no te ha llegado", "Ver detalles", []string{"Un reembolso que iniciamos para ti fue devuelto por el banco, así que el dinero no ha llegado a tu cuenta.", "No ha fallado nada por tu parte y no tienes que volver a pagar. Responde a este correo o escribe a billing@threkir.com y buscaremos otra forma de devolvértelo."}},
		...
		"safety_overdue":     {"¿Está bien %s? Su carrera dejó de dar señales", "No se recibe su posición desde hace un rato: revisa su progreso en directo.", "Sin novedades recientes de %s", "Ver progreso en directo", []string{"%s empezó una carrera a las %s y reportó su última posición a las %s. Es más tiempo que la ventana de aviso que configuró.", "%s empezó una carrera a las %s y no se ha recibido ninguna posición desde el inicio. Es más tiempo que la ventana de aviso que configuró.", "Esto también puede deberse a pérdida de señal o a que la app se cerró. Revisa su progreso en directo abajo; si no logras contactarle y estás preocupado, considera avisar a los servicios de emergencia locales."}},
		"safety_off_route":   {"¿%s sigue en ruta? Se ha salido de su recorrido", "Fuera de la ruta prevista desde hace un rato: revisa su progreso en directo.", "%s se ha salido de la ruta", "Ver progreso en directo", []string{"%s empezó una carrera a las %s y, desde las %s, se ha alejado bastante de la ruta prevista y sigue ahí.", "%s empezó una carrera a las %s y se ha alejado bastante de la ruta prevista.", "Esto también puede ser un desvío deliberado o un fallo del GPS. Revisa su progreso en directo abajo; si no logras contactarle y estás preocupado, considera avisar a los servicios de emergencia locales."}},
	...
	"ja": {
		...
		"plan_assigned":      {"コーチがトレーニングプランを割り当てました", "新しいプランがトレーニングに追加されました。", "新しいトレーニングプランが割り当てられました", "プランを見る", []string{"コーチがあなたにトレーニングプランを割り当てました。", "今週のセッションと目標ペースを確認しましょう。"}},
		"achievement":        {"新しいアチーブメントを獲得しました", "新しいアチーブメントがプロフィールに追加されました。", "新しいアチーブメントを獲得", "アチーブメントを見る", []string{"Threkir で新しいアチーブメントを獲得しました。", "何で獲得できたかを確認して、よければシェアしましょう。"}},
		"challenge_complete": {"チャレンジを達成しました", "目標を達成しました。最終順位を確認しましょう。", "チャレンジ達成", "チャレンジを見る", []string{"参加中のチャレンジで目標を達成しました。", "最終順位とあなたの記録を確認しましょう。"}},
		"data_export_ready":  {"データのエクスポートが完了しました", "アカウントのエクスポートが完了しました。設定から取得できます。", "データのエクスポートが完了しました", "設定を開く", []string{"リクエストされたアカウントのエクスポートが完了しました。", "設定からアカウントを開いてダウンロードしてください。ダウンロードリンクはその時点で作成されるため、このメールの内容が先に期限切れになることはありません。アーカイブ自体は7日間保存されます。"}},
		"refund_failed":      {"開始した返金が完了しませんでした", "代金はまだ当方にあります。別の方法で返金の手配をします。", "返金がお手元に届きませんでした", "詳細を見る", []string{"お客様のために開始した返金が銀行から差し戻されたため、代金はお客様の口座に届いていません。", "お客様側に問題はなく、再度お支払いいただく必要もありません。このメールにご返信いただくか billing@threkir.com までご連絡ください。別の方法で返金の手配をします。"}},
		...
		"safety_overdue":     {"%s さんは大丈夫ですか？ランの更新が途絶えています", "しばらく位置情報が届いていません。ライブ進行状況を確認してください。", "%s さんから最近の更新がありません", "ライブ進行状況を見る", []string{"%s さんは %s にランを開始し、最後の位置報告は %s でした。設定された通知までの時間を超えています。", "%s さんは %s にランを開始しましたが、開始以降位置情報が届いていません。設定された通知までの時間を超えています。", "電波が届かない場所にいる、またはアプリが終了した可能性もあります。下のリンクからライブ進行状況を確認してください。連絡が取れず心配な場合は、現地の緊急通報への連絡もご検討ください。"}},
		"safety_off_route":   {"%s さんはコース上にいますか？ルートを外れています", "しばらく予定ルートを外れています。ライブ進行状況を確認してください。", "%s さんがルートを外れました", "ライブ進行状況を見る", []string{"%s さんは %s にランを開始し、%s の時点で予定ルートから大きく外れ、そのままになっています。", "%s さんは %s にランを開始し、予定ルートから大きく外れています。", "意図的な迂回や GPS の誤差の可能性もあります。下のリンクからライブ進行状況を確認してください。連絡が取れず心配な場合は、現地の緊急通報への連絡もご検討ください。"}},
	...
	"pt-BR": {
		...
		"plan_assigned":      {"Seu treinador atribuiu um plano de treino a você", "Um novo plano está esperando no seu treino.", "Novo plano de treino atribuído", "Ver plano", []string{"Seu treinador atribuiu um plano de treino a você.", "Abra para ver as sessões desta semana e seus ritmos alvo."}},
		"achievement":        {"Você conquistou uma nova conquista", "Uma nova conquista está no seu perfil.", "Nova conquista obtida", "Ver conquista", []string{"Você conquistou uma nova conquista no Threkir.", "Abra para ver o que a desbloqueou — e compartilhe se quiser."}},
		"challenge_complete": {"Você completou um desafio", "Você bateu a meta — veja a classificação final.", "Desafio concluído", "Ver desafio", []string{"Você bateu a meta de um desafio em que está participando.", "Abra para ver a classificação final e o seu resultado."}},
		"data_export_ready":  {"Sua exportação de dados está pronta", "A exportação da sua conta terminou — pegue-a em Configurações.", "Sua exportação de dados está pronta", "Abrir Configurações", []string{"A exportação de conta que você pediu terminou de ser gerada.", "Abra Configurações e depois Conta para baixá-la. O link de download é criado quando você chega lá, então nada neste e-mail expira enquanto espera — o arquivo em si fica guardado por 7 dias."}},
		"refund_failed":      {"Um reembolso que iniciamos não pôde ser concluído", "O dinheiro ainda está conosco — vamos combinar outra forma de devolver.", "Seu reembolso não chegou até você", "Ver detalhes", []string{"Um reembolso que iniciamos para você foi devolvido pelo banco, então o dinheiro não chegou à sua conta.", "Nada deu errado do seu lado e você não precisa pagar de novo. Responda a este e-mail ou escreva para billing@threkir.com e vamos combinar outra forma de devolver."}},
		...
		"safety_overdue":     {"%s está bem? A corrida parou de atualizar", "Nenhuma posição recebida há algum tempo — veja o progresso ao vivo.", "Sem atualizações recentes de %s", "Ver progresso ao vivo", []string{"%s começou uma corrida às %s e reportou a última posição às %s. Isso passou da janela de alerta que a pessoa configurou.", "%s começou uma corrida às %s e nenhuma posição foi recebida desde o início. Isso passou da janela de alerta que a pessoa configurou.", "Isso também pode ser perda de sinal ou o app fechado. Veja o progresso ao vivo abaixo; se você não conseguir contato e estiver preocupado, considere acionar os serviços de emergência locais."}},
		"safety_off_route":   {"%s ainda está no trajeto? Saiu da rota", "Fora da rota planejada há algum tempo — veja o progresso ao vivo.", "%s saiu da rota", "Ver progresso ao vivo", []string{"%s começou uma corrida às %s e, desde as %s, se afastou bastante da rota planejada e continua fora.", "%s começou uma corrida às %s e se afastou bastante da rota planejada.", "Isso também pode ser um desvio proposital ou uma falha de GPS. Veja o progresso ao vivo abaixo; se você não conseguir contato e estiver preocupado, considere acionar os serviços de emergência locais."}},
	...
	"pt-PT": {
		...
		"refund_failed":      {"Um reembolso que iniciámos não pôde ser concluído", "O dinheiro continua connosco — vamos combinar outra forma de o devolver.", "O seu reembolso não chegou", "Ver detalhes", []string{"Um reembolso que iniciámos para si foi devolvido pelo banco, pelo que o dinheiro não chegou à sua conta.", "Nada correu mal do seu lado e não tem de pagar de novo. Responda a este e-mail ou escreva para billing@threkir.com e vamos combinar outra forma de o devolver."}},
