...
export const PAIRS = [
	...
	{ tableColumn: 'club_members.status', tsUnion: 'MembershipStatus' },
	{ tableColumn: 'clubs.join_policy', tsUnion: 'JoinPolicy' },
	{ tableColumn: 'coach_athletes.status', tsUnion: 'CoachAthleteStatus' },
	{ tableColumn: 'training_plans.status', tsUnion: 'PlanStatus' },
	{ tableColumn: 'events.recurrence_freq', tsUnion: 'RecurrenceFreq' },
	{ tableColumn: 'event_attendees.status', tsUnion: 'RsvpStatus' },
	{ tableColumn: 'challenges.activity_type', tsUnion: 'ActivityType' },
