...
Stack: SvelteKit 2 + Svelte 5 (runes), TypeScript, `@sveltejs/adapter-static`, custom CSS in `src/app.css`. The `/api/coach` route doubles as the body of a hand-rolled Node 24 Lambda handler under [`lambda/coach/`](lambda/coach/).
