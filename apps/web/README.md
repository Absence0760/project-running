...
The web app — **canonical feature surface for the whole product** ([decisions.md § 24](../../docs/decisions.md#24-web-is-the-canonical-feature-surface-mobile-and-watches-are-platform-additive)). Every user-facing feature lives here unless it is physically impossible in a browser (live GPS recording, device sensors, haptics, OS share sheets).
...
- [`../../docs/web_app_auth.md`](../../docs/web_app_auth.md) — auth flow
