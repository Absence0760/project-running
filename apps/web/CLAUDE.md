...
lambda/
  ...
  osrm-proxy/       # GET-only JSON Lambda for /api/routes/osrm/* — the server hop for
                    ...
                    # decisions §242). Wraps $lib/routes/osrm_proxy/handler (validates +
