...
src/
  ...
  routes/
    +layout.svelte  # App shell with collapsible sidebar (state persisted in localStorage as `sidebar_collapsed`). Sidebar shape: Dashboard · History · Runs · Gym · Nutrition · Routes · Coach · Social.
