...
grant delete, insert, select, update on public.global_segment_efforts to anon;
grant delete, insert, select, update on public.global_segment_efforts to authenticated;
grant delete, insert, select, update on public.global_segment_efforts to service_role;
grant delete, insert, select, update on public.global_segments to anon;
grant delete, insert, select, update on public.global_segments to authenticated;
grant delete, insert, select, update on public.global_segments to service_role;
