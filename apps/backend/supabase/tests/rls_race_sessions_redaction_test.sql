...
-- `race_sessions.auto_approve` (whether results land approved or
...
--
-- Coverage:
--   1. Club admin reads `started_by` + `auto_approve` unmasked via
--      the view.
...
select results_eq(
  $$ select started_by::text, auto_approve from race_sessions_redacted
     where event_id = '88888888-8888-8888-8888-888888888801' $$,
  $$ values ('00000000-0000-0000-0000-0000000000ad'::text, false) $$,
  'admin reads started_by + auto_approve unmasked via the view'
);
...
select results_eq(
  $$ select started_by, auto_approve from race_sessions_redacted
     where event_id = '88888888-8888-8888-8888-888888888801' $$,
  $$ values (null::uuid, null::boolean) $$,
  'non-admin authenticated caller sees NULL for started_by + auto_approve'
);
...
select results_eq(
  $$ select started_by, auto_approve from race_sessions_redacted
     where event_id = '88888888-8888-8888-8888-888888888801' $$,
  $$ values (null::uuid, null::boolean) $$,
  'anon sees NULL for started_by + auto_approve'
);
