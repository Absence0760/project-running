  ...
  testWidgets('records screen lists a weighted exercise and opens its progression',
    ...
    await tester.runAsync(() async {
      await store.createLocal(
        startedAt: DateTime.utc(2026, 2, 1),
        sets: const [(exerciseName: 'Bench', reps: 5, weightKg: 100.0, rpe: null, setType: null, durationS: null, exerciseId: null)],
      );
      await store.createLocal(
        startedAt: DateTime.utc(2026, 2, 8),
        sets: const [(exerciseName: 'Bench', reps: 3, weightKg: 110.0, rpe: null, setType: null, durationS: null, exerciseId: null)],
      );
    });
    try {
