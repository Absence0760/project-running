...
**Status:** Per `docs/roadmap.md`, Garmin Connect Developer API requires application + manual approval that's currently outstanding. Until that lands no Garmin e2e is possible.
...
- Mobile e2e (separate doc — [docs/mobile_e2e.md](mobile_e2e.md)).
