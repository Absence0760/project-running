...
### Store timestamp reader — `apps/mobile_android/test/offline_sync_timestamps_test.dart` (10) · `store_timestamp_reader_guard_test.dart` (2 source guards)
...
### `apps/mobile_ios/test/` — 547 files, byte-for-byte
...
### `apps/watch_wear/android/app/src/test/kotlin/**/*Test.kt` — 752 Wear OS Kotlin/JUnit tests across 73 files
...
### `scripts/check_watch_ios_source.test.mjs` — 74 tests
...
### `apps/web/tests-e2e/**/*.spec.ts` — 1,793 declared tests across 475 spec files (Playwright suite)
...
### Club slug — `apps/web/src/lib/social/club_slug.test.ts` (13) · `apps/mobile_android/test/club_slug_test.dart` (13 mirror)
