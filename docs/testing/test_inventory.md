...
### `apps/mobile_ios/test/` — same 541 files, byte-for-byte
...
### `apps/watch_wear/.../*Test.kt` — 733 Wear OS Kotlin/JUnit tests across 71 files
...
### `apps/backend/supabase/tests/rls_*.sql` — pgtap RLS suite (484 planned assertions across 57 files)
...
### `apps/backend/supabase/functions/**/*.test.ts` — 947 deno tests across 70 files
...
### `apps/web/tests-e2e/` — Playwright suite (1,784 declared tests across 471 spec files)
