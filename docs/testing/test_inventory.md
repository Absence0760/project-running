...
### `apps/mobile_ios/test/` — 541 files, byte-for-byte
...
### `apps/watch_wear/android/app/src/test/kotlin/**/*Test.kt` — 741 Wear OS Kotlin/JUnit tests across 72 files
...
### `scripts/check_watch_ios_source.test.mjs` — 54 tests
...
### `apps/watch_garmin/scripts/check_garmin_source.sh` — 5 source-level claims, and `scripts/check_garmin_source.test.mjs` — 22 tests
...
### `apps/backend/supabase/tests/rls_*.sql` — 484 planned assertions across 57 files (pgtap RLS suite)
...
### `apps/web/tests-e2e/**/*.spec.ts` — 1,784 declared tests across 471 spec files (Playwright suite)
