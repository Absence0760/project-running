...
### `apps/web/src/lib/i18n/*.test.ts` — 145 tests across 13 files
...
### `scripts/check_watch_ios_source.test.mjs` — 47 tests
...
### `apps/watch_garmin/scripts/check_garmin_source.sh` — 5 source-level claims, and `scripts/check_garmin_source.test.mjs` — 20 tests
...
### `scripts/check_watch_doc_counts.test.mjs` — 27 tests
...
### `apps/custom_watch/core/src/route_simplify.rs` — 24 tests, `track_projection.rs` — 5, `run_heatmap.rs` — 10 (5 added across the three)
...
### `apps/custom_watch/core/src/run_stats.rs` — 21 tests (2 added, 1 replaced) and `grade_adjusted_pace.rs` — 30 (1 added)
...
### `apps/web/src/lib/share/lambda_site_origin.test.ts` — 3 tests (new)
