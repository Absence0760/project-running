...
*Shipped since this doc was written:* the **post-signup setup wizard** (`setup_wizard_screen.dart` + the `home_screen.dart` `onboarded_at` gate + `ApiClient.completeOnboarding`/`markOnboarded`).
