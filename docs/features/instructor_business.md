...
| 5 Teach / follow along | **MISSING (M5, deferred)** | No `SessionRunner`/`GymWorkoutRunner`, no follow-along screen. Gated on the M3/M4 engagement signal. |
