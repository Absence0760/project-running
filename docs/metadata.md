...
| `notes` | `string` — free-form user notes | `mobile_android/screens/run_detail_screen.dart` (edit dialog); `mobile_android/screens/add_run_screen.dart` (manual entry form) | `mobile_android/screens/run_detail_screen.dart` | Optional; empty string when absent | Not currently read on the web. |
