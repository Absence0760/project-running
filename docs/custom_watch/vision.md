...
|---|---|---|---|
| 1 | **100+ hour GPS battery life** | 100mi events take 18–36 hours; multi-day FKTs need 3x buffer for backcountry safety | Low-power MCU (Ambiq Apollo510B production target per [§ 90](../decisions.md#90-bom-refresh-2026-05-28--apollo510b--bmp581-swap-ins-supply-alternates-qualified) / Nordic nRF52840 tier-1 stand-in per [§ 80](../decisions.md#80-tier-1-firmware-uses-embassy-on-rust-on-the-nordic-nrf52840--chosen-for-memory-safety-tooling-and-async-ergonomics-not-for-performance)), MIP display not AMOLED, custom RTOS not Wear OS, ~600–800 mAh battery |
