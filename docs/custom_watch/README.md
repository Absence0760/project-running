...
What counts as *verified* in these docs — and what the bench phase has to demonstrate the day the parts arrive — is defined in [`quality_standards.md`](quality_standards.md) ([decisions § 299](../architecture/decisions.md)). Read it before writing "verified" anywhere in this directory or in the workspace README.
