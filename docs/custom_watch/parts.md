...
| **Run time** | **~12-15 h, derived not measured** | ~25 mA GNSS continuous + ~6 mA MCU + ~2 mA board + under 1 mA for display, baro and duty-cycled HR ≈ 33 mA against 500 mAh. Plenty for § 82's one outdoor run; nowhere near the multi-day story, which is the point of tier 2. The PPK2 is what turns this into a number |
