...
What's *not* on this list: building your own watch from scratch. That's what the [§71 deferral](../decisions.md#71-own-hardware-an-ultra-marathon-watch-stays-research-only-watch-development-is-deferred-indefinitely) is about. The competitive analysis here is the evidence behind that deferral.
