...
tests-e2e/
  ...
  cross-cutting/               — span >1 page or >1 session
    ...
    privacy-zones.spec.ts      — owner Share guardrail when track crosses a zone (cancel + confirm paths)
