...
### `apps/web/tests-e2e/` — Playwright suite (29 tests across 6 files)
...
**Eight production bugs were fixed during the suite's authoring passes.** Each was a real defect, not test scaffolding:
