...
### `apps/web/tests-e2e/` — Playwright suite (58 tests across 27 files)
...
tests-e2e/
  ...
  plans/
    list.spec.ts               — /plans (drills into /plans/[id])
  clubs/
