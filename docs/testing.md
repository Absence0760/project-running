...
### `apps/web/tests-e2e/` — Playwright suite (87 tests across 43 files)
...
**Ten production bugs were fixed during the suite's authoring passes.** Each was a real defect, not test scaffolding:
