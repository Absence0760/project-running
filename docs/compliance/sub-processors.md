...
| **Sentry** | User uuid (pseudonymous), URL paths, error stack traces, breadcrumbs (redacted) | US (default) — verify project region | Legitimate interest (operational error monitoring) | <https://sentry.io/legal/dpa/> | TODO: opt-out toggle in Settings (not built yet) |
