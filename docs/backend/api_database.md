...
The `achievement` kind (migration `20270206_001`) fires from the
...
revoke the bronze). Shipped in `20270206_001_achievements.sql`. The badge
...
+ [decisions.md § 161](../architecture/decisions.md).
