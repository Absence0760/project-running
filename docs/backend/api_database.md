...
create table user_profiles (
  ...
  avatar_url               text,
  handle                   text,                                -- public @username (issue #465, 20270425_001); lowercase [a-z0-9_]{3,30}, case-insensitively unique, world-readable
