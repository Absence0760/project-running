...
## 231. Solo runs recorded after dark with no live share get a one-time, throttled, dismissible nudge — the pure decision is twinned, the banner is a mobile-only L4 surface
