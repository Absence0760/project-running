...
## 178. Learn-guide prose localizes via a `<slug>.<locale>.md` lookup with field-by-field English fallback — applied uniformly to body, H1, and listing cards; the English copy stays the prerendered canonical
