...
| `apps/web/src/lib/gym/routine_history.ts` (`summariseRoutineHistory`) | `apps/mobile_android/lib/routine_history.dart` | `gym/routine_history.test.ts` ↔ `test/routine_history_test.dart` |
