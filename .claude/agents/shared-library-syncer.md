...
| `apps/web/src/lib/routes/roadbook.ts` (`buildRoadbook`, `CUTOFF_TIGHT_S`; reuses `parseCutoff` from `route_markers`) | `apps/mobile_android/lib/roadbook.dart` | `routes/roadbook.test.ts` ↔ `test/roadbook_test.dart` |
