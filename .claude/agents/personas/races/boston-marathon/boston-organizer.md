...
9. **Anon public access to the tracker + leaderboard.** Spectators follow without accounts (cf. the round-1 anon live-spectator finding). Does the leaderboard work logged-out at 30k scale, and does it **over-expose** — every runner's precise live coordinates / home / privacy-zone start to anyone? Check `fetchClippedTrackForRun` on the spectator path.
